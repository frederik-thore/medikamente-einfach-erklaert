const reviewedDrafts = [
  ...
  {
    id: "glycerol-zaepfchen",
    name: "Glycerol (Zäpfchen)",
    examples: "Referenzpräparat: Milax® 1,0 Zäpfchen",
    category: "Abführmittel",
    purpose: "Glycerol-Zäpfchen werden kurzfristig bei Verstopfung eingesetzt, wenn eine Entleerung des Enddarms unterstützt werden soll.",
    does: "Sie ziehen Wasser in den Enddarm und können den Stuhl weicher machen sowie den Entleerungsreiz auslösen.",
    doesNot: "Sie behandeln nicht die Ursache einer neuen, starken oder wiederkehrenden Verstopfung und sind keine Dauerbehandlung.",
    daily: "Zäpfchen sind nicht zum Einnehmen. Bei kleinen Kindern muss Verstopfung ärztlich abgeklärt werden; Stärke, Alter und die konkrete Packung prüfen. Die App berechnet keine Dosis.",
    sideEffects: "Reizung, Brennen oder Schmerzen im Enddarm und selten Bauchkrämpfe oder Durchfall können auftreten.",
    urgent: "Bei starken Bauchschmerzen, Erbrechen, aufgeblähtem Bauch, Blut im Stuhl oder wenn weder Stuhl noch Winde abgehen: zeitnah medizinisch abklären lassen.",
    source: "Gebrauchsinformation: Milax® 1,0 Zäpfchen (abgerufen am 24.07.2026)",
    sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/m/milaxR-10?kontrast=an",
  ...
  {
    id: "ethinylestradiol-levonorgestrel", name: "Ethinylestradiol / Levonorgestrel", examples: "Referenzpräparat: Levonance® 30 Filmtabletten", category: "Hormonelle Verhütung",
    purpose: "Die Kombination wird zur hormonellen Schwangerschaftsverhütung eingesetzt.",
    does: "Sie verhindert bei korrekter Anwendung eine Schwangerschaft, vor allem durch Hemmung des Eisprungs und Veränderungen des Zervixschleims.",
    doesNot: "Sie schützt nicht vor sexuell übertragbaren Infektionen und ist nicht für jede Person mit einem Thrombose-, Herz-Kreislauf- oder Migränerisiko geeignet.",
    daily: "Nur nach dem persönlichen Verhütungsplan anwenden. Bei Erbrechen, Durchfall oder neuen Arzneimitteln kann der Schutz beeinträchtigt sein; Packungsbeilage, Apotheke oder Praxis fragen. Nicht selbst zwischen Präparaten wechseln.",
    sideEffects: "Möglich sind Übelkeit, Kopfschmerzen, Brustspannen, Stimmungsschwankungen oder unregelmäßige Blutungen. Kombinierte hormonelle Verhütung erhöht das Risiko für Blutgerinnsel.",
    urgent: "Bei einseitiger Beinschwellung oder -schmerz, plötzlicher Atemnot, Brustschmerz, Husten mit Blut, plötzlich auftretender Seh-, Sprach- oder Gefühlsstörung sofort medizinische Hilfe holen.",
    source: "Gebrauchsinformation: Levonance® 30 0,03 mg/0,15 mg Filmtabletten (abgerufen am 24.07.2026)", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/l/levonanceR-30-003-mg015-mg-filmtabletten", reviewStatus: "Quellenbasierter Entwurf"
  },
  {
    id: "desogestrel", name: "Desogestrel", examples: "Referenzpräparat: Solgest® 75 Mikrogramm Filmtabletten", category: "Hormonelle Verhütung",
    purpose: "Desogestrel wird als reine Gestagenpille zur Schwangerschaftsverhütung eingesetzt.",
    does: "Es verändert den Schleim am Gebärmutterhals und verhindert bei den meisten Anwenderinnen auch den Eisprung.",
    doesNot: "Es schützt nicht vor sexuell übertragbaren Infektionen und ersetzt keine Schwangerschaftsabklärung bei ausbleibender Blutung oder Beschwerden.",
    daily: "Nur nach dem persönlichen Verhütungsplan anwenden. Erbrechen, Durchfall und manche Arzneimittel können den Schutz beeinflussen; bei Unsicherheit sofort Packungsbeilage, Apotheke oder Praxis einbeziehen.",
    sideEffects: "Unregelmäßige Blutungen oder ein Ausbleiben der Blutung, Kopfschmerzen, Akne, Stimmungsschwankungen, Brustspannen oder Übelkeit können auftreten.",
    urgent: "Bei starker oder ungewohnter Blutung, starken Unterbauchschmerzen, Verdacht auf Schwangerschaft, Schwellung von Gesicht oder Hals, Atemnot oder schwerer allergischer Reaktion zeitnah medizinische Hilfe holen.",
    source: "Gebrauchsinformation: Solgest® 75 Mikrogramm Filmtabletten (abgerufen am 24.07.2026)", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/s/solgest-75-mikrogramm-filmtabletten?schrift=0.7", reviewStatus: "Quellenbasierter Entwurf"
  },
  {
    id: "adapalen", name: "Adapalen", examples: "Referenzpräparat: Differin® 0,1 % Gel", category: "Aknemittel",
    purpose: "Adapalen-Gel wird zur äußerlichen Behandlung von Akne mit Mitessern, Pickeln und entzündlichen Knötchen eingesetzt.",
    does: "Es gehört zu den Retinoiden, löst Mitesser und kann der Bildung neuer Mitesser entgegenwirken.",
    doesNot: "Es wirkt nicht sofort und ist nicht für jede Hautrötung oder Hautinfektion geeignet. Es darf in Schwangerschaft oder bei geplantem Kinderwunsch nicht angewendet werden.",
    daily: "Nur auf die vorgesehene Haut auftragen und Augen, Lippen sowie Schleimhäute meiden. Haut kann empfindlicher auf Sonne und UV-Licht reagieren; Sonnenschutz und der persönliche Hautplan sind wichtig.",
    sideEffects: "Brennen, Rötung, trockene oder schuppige Haut, Juckreiz und Reizung können besonders zu Beginn auftreten.",
    urgent: "Bei deutlicher Schwellung, Atemnot, großflächigem Ausschlag, Blasen, starker Hautreizung oder Eintritt einer Schwangerschaft Anwendung stoppen und ärztlich abklären lassen.",
    source: "Gebrauchsinformation: Differin® 0,1 % Gel (abgerufen am 24.07.2026)", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/d/differin-01-gel?kontrast=an", reviewStatus: "Quellenbasierter Entwurf"
  },
  {
    id: "metronidazol-haut", name: "Metronidazol (Creme bei Rosazea)", examples: "Referenzpräparat: Metrocreme® 0,75 %", category: "Rosazea-Mittel",
    purpose: "Metronidazol-Creme wird bei bestimmten Formen der Rosazea im Gesicht eingesetzt.",
    does: "Sie kann Entzündung und rosazea-typische Hautveränderungen verringern.",
    doesNot: "Sie ist keine Aknecreme und behandelt weder jede Gesichtsrötung noch eine bakterielle Hautinfektion oder Augenbeschwerden durch Rosazea.",
    daily: "Nur äußerlich und nach dem persönlichen Hautplan anwenden. Augen, Lippen und Schleimhäute meiden; bei Schwangerschaft, Stillzeit oder Blutbildproblemen vorher mit Praxis oder Apotheke sprechen.",
    sideEffects: "Trockene Haut, Brennen, Reizung, Juckreiz oder eine vorübergehende Verschlechterung der Rosazea können auftreten.",
    urgent: "Bei Schwellung von Gesicht oder Hals, Atemnot, schwerem Ausschlag, Blasen, starken Augenschmerzen oder Sehstörungen sofort medizinische Hilfe holen.",
    source: "Gebrauchsinformation: Metrocreme® 0,75 % (abgerufen am 24.07.2026)", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/m/metrocreme-075-?kontrast=an&schrift=0.7", reviewStatus: "Quellenbasierter Entwurf"
  }
];
...
const commonBrandAliases = {
  ...
  "ethinylestradiol-levonorgestrel": ["Levonance 30", "Leona HEXAL"], desogestrel: ["Solgest", "Cerazette", "Desogestrel Aristo"], adapalen: ["Differin", "Dipalen"], "metronidazol-haut": ["Metrocreme", "Rosiced"],
...
const verifiedPreparationsRaw = [
  ...
  { tradeName: "Paracetamol 500 mg HEXAL bei Fieber und Schmerzen", medicationId: "paracetamol", strength: "500 mg Paracetamol", dosageForm: "Tabletten", audience: "Jugendliche und Erwachsene gemäß Gebrauchsinformation", safetyNote: "Die tatsächliche Packung sowie Alter und Körpergewicht prüfen. Nicht mit weiteren paracetamolhaltigen Arzneimitteln doppelt anwenden; die App berechnet keine Dosis.", status: "Produktinformation abgeglichen", checkedOn: "24.07.2026", sourceLabel: "PatientenInfo-Service: Paracetamol 500 mg HEXAL", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/pq/paracetamol-500mg-hexal-bei-fieber-und-schmerzen-tabletten" },
  { tradeName: "Ibuflam 40 mg/ml", medicationId: "ibuprofen", strength: "40 mg/ml Ibuprofen", dosageForm: "Suspension zum Einnehmen", audience: "Kinder ab 1 Jahr sowie Jugendliche und Erwachsene gemäß Gebrauchsinformation", safetyNote: "Die Konzentration 40 mg/ml nicht mit 20-mg/ml-Säften verwechseln. Körpergewicht, Alter, konkrete Packung und Trinkmenge prüfen; die App berechnet keine Dosis.", status: "Produktinformation abgeglichen", checkedOn: "24.07.2026", sourceLabel: "PatientenInfo-Service: Ibuflam 40 mg/ml", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/i/ibuflam-40mgml" },
  { tradeName: "ibuTAD 400 mg gegen Schmerzen und Fieber", medicationId: "ibuprofen", strength: "400 mg Ibuprofen", dosageForm: "Filmtabletten", audience: "Jugendliche und Erwachsene gemäß Gebrauchsinformation", safetyNote: "Diese Tablettenstärke ist keine Ersatzform für einen Kindersaft oder ein Kinderzäpfchen. Nicht zusammen mit anderen ibuprofenhaltigen Arzneimitteln anwenden; die App berechnet keine Dosis.", status: "Produktinformation abgeglichen", checkedOn: "24.07.2026", sourceLabel: "PatientenInfo-Service: ibuTAD 400 mg", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/i/ibutadR-400-mg-gegen-schmerzen-und-fieber-filmtabletten" },
  { tradeName: "Otriven 0,05 % Dosierspray ohne Konservierungsstoffe", medicationId: "xylometazolin", strength: "0,5 mg/ml Xylometazolinhydrochlorid", dosageForm: "Nasenspray, Lösung", audience: "Kinder von 2 bis 6 Jahren", safetyNote: "Kindervariante: nicht mit 0,1-%-Sprays für Erwachsene und Jugendliche verwechseln. Nur kurz nach der Gebrauchsinformation anwenden; die App berechnet keine Dosis.", status: "Produktinformation abgeglichen", checkedOn: "24.07.2026", sourceLabel: "PatientenInfo-Service: Otriven 0,05 % Dosierspray", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/o/otriven-005--dosierspray-ohne-konservierungsstoffe?kontrast=an" },
  { tradeName: "Otriven gegen Schnupfen 0,1 % Dosierspray", medicationId: "xylometazolin", strength: "1 mg/ml Xylometazolinhydrochlorid", dosageForm: "Nasenspray, Lösung", audience: "Erwachsene und Jugendliche ab 12 Jahren", safetyNote: "Die 0,1-%-Stärke ist keine Kindervariante. Nur kurz nach der Gebrauchsinformation anwenden; die App berechnet keine Dosis.", status: "Produktinformation abgeglichen", checkedOn: "24.07.2026", sourceLabel: "PatientenInfo-Service: Otriven 0,1 % Dosierspray", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/o/otriven-gegen-schnupfen-01--dosierspray-ohne-konservierungsstoffe" },
  { tradeName: "Vomex A 12,5 mg Kinder", medicationId: "dimenhydrinat", strength: "12,5 mg Dimenhydrinat", dosageForm: "Lösung zum Einnehmen im Beutel", audience: "Kindervariante – Alters- und Gewichtsbereich der Packung prüfen", safetyNote: "Überdosierungen können besonders bei kleinen Kindern lebensbedrohlich sein. Nicht mit anderen beruhigenden Arzneimitteln kombinieren, ohne ärztlichen oder apothekerlichen Rat; die App berechnet keine Dosis.", status: "Produktinformation abgeglichen", checkedOn: "24.07.2026", sourceLabel: "PatientenInfo-Service: Vomex A 12,5 mg Kinder", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/uv/vomex-a-125-mg-kinder-loesung-zum-einnehmen-im-beutel?schrift=0.7" },
  { tradeName: "Vomex A Kinder-Suppositorien 40 mg", medicationId: "dimenhydrinat", strength: "40 mg Dimenhydrinat", dosageForm: "Zäpfchen", audience: "Kindervariante – Alters- und Gewichtsbereich der Packung prüfen", safetyNote: "Zäpfchen sind nicht mit Saft oder Beuteln gleichzusetzen. Überdosierungen können besonders bei Kindern lebensbedrohlich sein; die App berechnet keine Dosis.", status: "Produktinformation abgeglichen", checkedOn: "24.07.2026", sourceLabel: "PatientenInfo-Service: Vomex A Kinder-Suppositorien 40 mg", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/uv/vomex-a-kinder-suppositorien-40-mg" },
  { tradeName: "Salbutamol – 1 A Pharma 0,1 mg", medicationId: "salbutamol", strength: "100 Mikrogramm Salbutamol pro Sprühstoß", dosageForm: "Druckgasinhalation, Suspension (Dosieraerosol)", audience: "Kinder ab 4 Jahren, Jugendliche und Erwachsene gemäß Gebrauchsinformation", safetyNote: "Die Inhalationstechnik muss gezeigt und regelmäßig kontrolliert werden. Zunehmender Bedarf oder Atemnot trotz des persönlichen Plans sind Warnzeichen; die App berechnet keine Dosis.", status: "Produktinformation abgeglichen", checkedOn: "24.07.2026", sourceLabel: "PatientenInfo-Service: Salbutamol – 1 A Pharma 0,1 mg", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/s/salbutamol-1a-pharma-01mg-druckgasinhalation-suspension-dosieraerosol?schrift=0.7" },
  { tradeName: "Sultanol Inhalationslösung 5 mg/1 ml", medicationId: "salbutamol", strength: "5 mg Salbutamol pro 1 ml", dosageForm: "Lösung für einen Vernebler", audience: "Nur nach ärztlichem Inhalationsplan; bei Kindern unter Anleitung", safetyNote: "Nicht mit einem Dosieraerosol verwechseln. Verdünnung, Inhalationsgerät und Anwendungstechnik gehören zum persönlichen Plan; bei zunehmender Atemnot sofort Hilfe holen. Die App berechnet keine Dosis.", status: "Produktinformation abgeglichen", checkedOn: "24.07.2026", sourceLabel: "PatientenInfo-Service: Sultanol Inhalationslösung 5 mg/1 ml", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/s/sultanol-inhalationsloesung-5-mg1-ml-loesung-fuer-einen-vernebler?kontrast=an" },
  { tradeName: "Budesonid Easyhaler 0,4 mg/Dosis", medicationId: "budesonid", strength: "400 Mikrogramm Budesonid pro abgegebener Dosis", dosageForm: "Pulver zur Inhalation", audience: "Kinder ab 6 Jahren, Jugendliche und Erwachsene gemäß Gebrauchsinformation", safetyNote: "Kein Notfallinhalator. Das Kind muss den Easyhaler korrekt anwenden können; nach der Inhalation Mund ausspülen und ausspucken. Die App berechnet keine Dosis.", status: "Produktinformation abgeglichen", checkedOn: "24.07.2026", sourceLabel: "PatientenInfo-Service: Budesonid Easyhaler 0,4 mg/Dosis", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/b/budesonid-easyhaler-04-mgdosis-pulver-zur-inhalation" },
  { tradeName: "Pulmicort 0,5 mg/2 ml Suspension", medicationId: "budesonid", strength: "0,5 mg Budesonid pro 2 ml", dosageForm: "Suspension zur Inhalation mit Vernebler", audience: "Säuglinge ab 6 Monaten, Kinder, Jugendliche und Erwachsene gemäß ärztlichem Plan", safetyNote: "Nur mit dem vorgesehenen Vernebler und nach Einweisung anwenden. Die konkrete Verneblertechnik und ärztliche Anweisung sind maßgeblich; die App berechnet keine Dosis.", status: "Produktinformation abgeglichen", checkedOn: "24.07.2026", sourceLabel: "PatientenInfo-Service: Pulmicort 0,5 mg/2 ml Suspension", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/pq/pulmicortR-05-mg2-ml-suspension/" },
  { tradeName: "LoranoPro 0,5 mg/ml Lösung zum Einnehmen", medicationId: "desloratadin", strength: "0,5 mg/ml Desloratadin", dosageForm: "Lösung zum Einnehmen", audience: "Erwachsene, Jugendliche und Kinder ab 2 Jahren", safetyNote: "Messhilfe, Alter und konkrete Packung prüfen. Bei Kindern nicht mit einer Tablette oder einer anderen Antihistaminika-Lösung verwechseln; die App berechnet keine Dosis.", status: "Produktinformation abgeglichen", checkedOn: "24.07.2026", sourceLabel: "PatientenInfo-Service: LoranoPro 0,5 mg/ml Lösung", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/l/loranopro-05mgml-loesung-zum-einnehmen-saft?schrift=0.9" },
  { tradeName: "Aerius 0,5 mg/ml Lösung zum Einnehmen", medicationId: "desloratadin", strength: "0,5 mg/ml Desloratadin", dosageForm: "Lösung zum Einnehmen", audience: "Kinder ab 1 Jahr, Jugendliche und Erwachsene", safetyNote: "Für Kinder unter 1 Jahr nicht vorgesehen. Messhilfe, Alter und konkrete Packung prüfen; die App berechnet keine Dosis.", status: "Produktinformation abgeglichen", checkedOn: "24.07.2026", sourceLabel: "PatientenInfo-Service: Aerius 0,5 mg/ml Lösung", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/a/aeriusr-05-mgml-loesung-zum-einnehmen?kontrast=an&schrift=0.7" },
  { tradeName: "Macrogol HEXAL plus Elektrolyte", medicationId: "macrogol", strength: "Beutel mit Macrogol 3350 und Elektrolyten", dosageForm: "Pulver zur Herstellung einer Lösung zum Einnehmen", audience: "Jugendliche ab 12 Jahren und Erwachsene", safetyNote: "Kein Kinderbeutel: Kindern unter 12 Jahren nicht geben. Bei starken Bauchschmerzen, Erbrechen oder aufgeblähtem Bauch zuerst medizinisch abklären; die App berechnet keine Dosis.", status: "Produktinformation abgeglichen", checkedOn: "24.07.2026", sourceLabel: "PatientenInfo-Service: Macrogol HEXAL plus Elektrolyte", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/m/macrogol-hexal-plus-elektrolyte-pulver" },
  { tradeName: "Lactulose HEXAL Sirup", medicationId: "lactulose", strength: "667 mg Lactulose pro ml", dosageForm: "Sirup", audience: "Kinder und Erwachsene gemäß Gebrauchsinformation", safetyNote: "Messhilfe, Alter und konkrete Packung prüfen. Bei Durchfall oder Erbrechen auf Flüssigkeitsverlust achten; die App berechnet keine Dosis.", status: "Produktinformation abgeglichen", checkedOn: "24.07.2026", sourceLabel: "PatientenInfo-Service: Lactulose HEXAL Sirup", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/l/lactulose-hexal-sirup" },
  { tradeName: "Milax 1,0", medicationId: "glycerol-zaepfchen", strength: "1 g Glycerol pro Zäpfchen", dosageForm: "Zäpfchen", audience: "Altersbereich der konkreten Packung prüfen", safetyNote: "Zäpfchen sind nicht zum Einnehmen. Bei Klein- und Kleinstkindern muss Verstopfung vorher ärztlich abgeklärt werden; die App berechnet keine Dosis.", status: "Produktinformation abgeglichen", checkedOn: "24.07.2026", sourceLabel: "PatientenInfo-Service: Milax 1,0", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/m/milaxR-10?kontrast=an" },
  { tradeName: "INFECTOMOX 250 Saft", medicationId: "amoxicillin", strength: "250 mg Amoxicillin pro 5 ml", dosageForm: "Pulver zur Herstellung einer Suspension zum Einnehmen", audience: "Kinder und Erwachsene nur nach ärztlicher Verordnung", safetyNote: "Die zubereitete Suspension, Messhilfe, Konzentration und Behandlungsplan müssen genau zur Packung passen. Nicht mit anderen Antibiotika-Säften verwechseln; die App berechnet keine Dosis.", status: "Produktinformation abgeglichen", checkedOn: "24.07.2026", sourceLabel: "PatientenInfo-Service: INFECTOMOX 250 Saft", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/i/infectomoxR-250-saft-250-mg5-ml-pulver-zur-herstellung-einer-suspension-zum-einnehmen" },
  { tradeName: "INFECTOCILLIN 250 Saft", medicationId: "phenoxymethylpenicillin", strength: "250.000 Einheiten Phenoxymethylpenicillin-Kalium pro 5 ml", dosageForm: "Pulver zur Herstellung einer Lösung zum Einnehmen", audience: "Kinder und Erwachsene nur nach ärztlicher Verordnung", safetyNote: "Die hergestellte Lösung, Messhilfe und der persönliche Behandlungsplan sind maßgeblich. Eine Penicillinallergie muss vor der ersten Einnahme bekannt sein; die App berechnet keine Dosis.", status: "Produktinformation abgeglichen", checkedOn: "24.07.2026", sourceLabel: "PatientenInfo-Service: INFECTOCILLIN 250 Saft", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/i/infectocillinR-250-saft-250000-einheiten5-ml-pulver-zur-herstellung-einer-loesung-zum-einnehmen" },
  { tradeName: "Cefuroxim – 1 A Pharma 125 mg/5 ml Trockensaft", medicationId: "cefuroxim", strength: "125 mg Cefuroxim pro 5 ml", dosageForm: "Trockensaft zur Herstellung einer Suspension zum Einnehmen", audience: "Kinder und Erwachsene nur nach ärztlicher Verordnung", safetyNote: "Nach Zubereitung nicht mit anderen Suspensionen verwechseln. Messhilfe, Konzentration und persönlicher Behandlungsplan sind maßgeblich; die App berechnet keine Dosis.", status: "Produktinformation abgeglichen", checkedOn: "24.07.2026", sourceLabel: "PatientenInfo-Service: Cefuroxim – 1 A Pharma 125 mg/5 ml", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/c/cefuroxim-1a-pharma-125mg5ml-trockensaft?schrift=0.7" },
  { tradeName: "InfectoScab 5 % Creme", medicationId: "permethrin", strength: "50 mg Permethrin pro g Creme", dosageForm: "Creme zur Anwendung auf der Haut", audience: "Ab 2 Monaten nur nach ärztlichem Plan", safetyNote: "Nicht schlucken und Augen, Schleimhäute sowie offene Wunden meiden. Bei Kindern bis 23 Monaten nur unter engmaschiger ärztlicher Aufsicht; die App berechnet keine Menge.", status: "Produktinformation abgeglichen", checkedOn: "24.07.2026", sourceLabel: "PatientenInfo-Service: InfectoScab 5 % Creme", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/i/infectoscabR-5--creme?kontrast=an&schrift=0.9" },
  { tradeName: "Canesten Creme", medicationId: "clotrimazol", strength: "10 mg Clotrimazol pro g Creme", dosageForm: "Creme zur Anwendung auf der Haut", audience: "Altersbereich und Anwendungsort der konkreten Packung prüfen", safetyNote: "Nicht jede gerötete Haut ist ein Pilz. Nicht in die Augen bringen und bei fehlender Besserung oder Ausbreitung ärztlich oder apothekerlich abklären; die App berechnet keine Menge.", status: "Produktinformation abgeglichen", checkedOn: "24.07.2026", sourceLabel: "PatientenInfo-Service: Canesten Creme", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/c/canesten-creme?schrift=0.7" },
  { tradeName: "Hydrocutan Creme 0,5 %", medicationId: "hydrocortison-haut", strength: "5 mg Hydrocortison pro g Creme", dosageForm: "Creme zur Anwendung auf der Haut", audience: "Erwachsene und Kinder ab 6 Jahren; jüngere Kinder nur ärztlich", safetyNote: "Nicht auf offene Wunden, ins Auge oder zur Behandlung einer Pilz-, Virus- oder Bakterieninfektion anwenden. Bei Kindern besonders kleinflächig und nur nach Vorgabe; die App berechnet keine Menge.", status: "Produktinformation abgeglichen", checkedOn: "24.07.2026", sourceLabel: "PatientenInfo-Service: Hydrocutan Creme 0,5 %", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/h/hydrocutan-creme-05-?kontrast=an" },
  { tradeName: "ECURAL Fettcreme", medicationId: "mometason-haut", strength: "1 mg Mometasonfuroat pro g Creme", dosageForm: "Fettcreme zur Anwendung auf der Haut", audience: "Nur nach ärztlicher Verordnung; Altersbereich der Packung prüfen", safetyNote: "Ein stark wirksames Kortisonmittel: nicht bei Hautinfektionen, Akne, Rosazea oder Windelausschlag anwenden. Dünn und genau nach dem persönlichen Plan; die App berechnet keine Menge.", status: "Produktinformation abgeglichen", checkedOn: "24.07.2026", sourceLabel: "PatientenInfo-Service: ECURAL Fettcreme", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/e/ecuralR-fettcreme?schrift=0.7" },
  { tradeName: "Fusicutan Creme", medicationId: "fusidinsaeure-creme", strength: "20 mg Fusidinsäure pro g Creme", dosageForm: "Creme zur Anwendung auf der Haut", audience: "Erwachsene und Kinder ab 2 Jahren", safetyNote: "Nur für die ärztlich beurteilte bakterielle Hautinfektion und genau so lange wie verordnet anwenden. Nicht mit Pilzcremes oder Kortisoncremes verwechseln; die App berechnet keine Menge.", status: "Produktinformation abgeglichen", checkedOn: "24.07.2026", sourceLabel: "PatientenInfo-Service: Fusicutan Creme", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/f/fusicutan-creme?kontrast=an" },
  { tradeName: "Levonance 30", medicationId: "ethinylestradiol-levonorgestrel", strength: "0,03 mg Ethinylestradiol + 0,15 mg Levonorgestrel", dosageForm: "Filmtabletten", audience: "Zur Anwendung bei Frauen nach ärztlicher Verordnung", safetyNote: "Nicht ohne Rücksprache wechseln oder absetzen. Das Risiko für Blutgerinnsel und mögliche Wechselwirkungen müssen individuell geprüft werden; die App berechnet keinen Einnahmeplan.", status: "Produktinformation abgeglichen", checkedOn: "24.07.2026", sourceLabel: "PatientenInfo-Service: Levonance 30", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/l/levonanceR-30-003-mg015-mg-filmtabletten" },
  { tradeName: "Solgest 75 Mikrogramm", medicationId: "desogestrel", strength: "75 Mikrogramm Desogestrel", dosageForm: "Filmtabletten", audience: "Zur Anwendung bei Frauen nach ärztlicher Verordnung", safetyNote: "Die Einnahme muss zum persönlichen Verhütungsplan passen. Bei Erbrechen, Durchfall oder neuen Arzneimitteln Packungsbeilage, Apotheke oder Praxis einbeziehen; die App berechnet keinen Einnahmeplan.", status: "Produktinformation abgeglichen", checkedOn: "24.07.2026", sourceLabel: "PatientenInfo-Service: Solgest 75 Mikrogramm", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/s/solgest-75-mikrogramm-filmtabletten?schrift=0.7" },
  { tradeName: "Differin 0,1 % Gel", medicationId: "adapalen", strength: "1 mg Adapalen pro g Gel", dosageForm: "Gel zur Anwendung auf der Haut", audience: "Nicht in Schwangerschaft oder bei geplantem Kinderwunsch anwenden", safetyNote: "Nur äußerlich anwenden und Sonne/UV meiden. Bei Schwangerschaft oder Kinderwunsch Anwendung sofort mit Praxis oder Apotheke klären; die App berechnet keine Menge.", status: "Produktinformation abgeglichen", checkedOn: "24.07.2026", sourceLabel: "PatientenInfo-Service: Differin 0,1 % Gel", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/d/differin-01-gel?kontrast=an" },
  { tradeName: "Metrocreme 0,75 %", medicationId: "metronidazol-haut", strength: "7,5 mg Metronidazol pro g Creme", dosageForm: "Creme zur Anwendung auf der Haut", audience: "Erwachsene; Anwendung bei Kindern und Jugendlichen nicht empfohlen", safetyNote: "Nicht in die Augen oder auf Schleimhäute bringen. Rosazea im Augenbereich oder starke Verschlechterung ärztlich beurteilen lassen; die App berechnet keine Menge.", status: "Produktinformation abgeglichen", checkedOn: "24.07.2026", sourceLabel: "PatientenInfo-Service: Metrocreme 0,75 %", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/m/metrocreme-075-?kontrast=an&schrift=0.7" },
  { tradeName: "Pantoprazol-ADGC 20 mg", medicationId: "pantoprazol", strength: "20 mg Pantoprazol", dosageForm: "Magensaftresistente Tabletten", audience: "Erwachsene gemäß Gebrauchsinformation", safetyNote: "Nicht als Erklärung für Schluckbeschwerden, Blutungen oder Gewichtsverlust verwenden. Bei längerem Bedarf oder Warnzeichen ärztlich abklären; die App berechnet keine Dosis.", status: "Produktinformation abgeglichen", checkedOn: "24.07.2026", sourceLabel: "PatientenInfo-Service: Pantoprazol-ADGC 20 mg", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/pq/pantoprazol-adgc-20mg" },
  { tradeName: "Omeprazol Mylan 20 mg", medicationId: "omeprazol", strength: "20 mg Omeprazol", dosageForm: "Magensaftresistente Hartkapseln", audience: "Erwachsene gemäß Gebrauchsinformation", safetyNote: "Kapseln nicht beliebig durch andere Formen ersetzen. Bei neuen Warnzeichen wie Schluckbeschwerden oder Blutungen sofort medizinisch abklären; die App berechnet keine Dosis.", status: "Produktinformation abgeglichen", checkedOn: "24.07.2026", sourceLabel: "PatientenInfo-Service: Omeprazol Mylan 20 mg", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/o/omeprazol-mylan-20-mg-magensaftresistente-hartkapseln" },
  { tradeName: "Loperamid PUREN 2 mg", medicationId: "loperamid", strength: "2 mg Loperamidhydrochlorid", dosageForm: "Hartkapseln", audience: "Erwachsene und Jugendliche ab 12 Jahren", safetyNote: "Bei Blut im Stuhl, Fieber, aufgeblähtem Bauch oder Colitis ulcerosa nicht eigenständig anwenden. Flüssigkeit und Salze ersetzen; die App berechnet keine Dosis.", status: "Produktinformation abgeglichen", checkedOn: "24.07.2026", sourceLabel: "PatientenInfo-Service: Loperamid PUREN 2 mg", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/l/loperamid-puren-2-mg-hartkapseln" },
  { tradeName: "Folsäure Aristo 5 mg", medicationId: "folsaeure", strength: "5 mg Folsäure", dosageForm: "Tabletten", audience: "Erwachsene, Kinder ab 6 Jahren und Jugendliche", safetyNote: "Diese Stärke ist nicht automatisch die richtige Folsäuremenge bei Kinderwunsch oder Schwangerschaft. Ursache, Vitamin-B12-Status und persönlicher Plan sind maßgeblich; die App berechnet keine Dosis.", status: "Produktinformation abgeglichen", checkedOn: "24.07.2026", sourceLabel: "PatientenInfo-Service: Folsäure Aristo 5 mg", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/f/folsaeure-aristo-5-mg-tabletten" },
  { tradeName: "Dekristol 1000 I.E.", medicationId: "colecalciferol", strength: "25 Mikrogramm Colecalciferol (Vitamin D3), entsprechend 1.000 I.E.", dosageForm: "Tabletten", audience: "Kinder, Jugendliche und Erwachsene gemäß Gebrauchsinformation", safetyNote: "Nicht zusammen mit weiteren Vitamin-D- oder Calciumpräparaten eigenständig hoch dosieren. Alter, Anlass und persönlicher Plan prüfen; die App berechnet keine Dosis.", status: "Produktinformation abgeglichen", checkedOn: "24.07.2026", sourceLabel: "PatientenInfo-Service: Dekristol 1000 I.E.", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/d/dekristol-1000-ie-tabletten?drucken=an" },
  { tradeName: "Sumatriptan dura 50 mg", medicationId: "sumatriptan", strength: "50 mg Sumatriptan", dosageForm: "Filmtabletten", audience: "Erwachsene gemäß persönlichem Migräneplan", safetyNote: "Nur für eine ärztlich bekannte Migräneattacke einsetzen. Bei Brustschmerz, Atemnot oder ungewohntem Kopfschmerz sofort Hilfe holen; die App berechnet keine Dosis.", status: "Produktinformation abgeglichen", checkedOn: "24.07.2026", sourceLabel: "PatientenInfo-Service: Sumatriptan dura 50 mg", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/s/sumatriptan-dura-50-mg-filmtabletten/" },
  { tradeName: "Rizatriptan PUREN 10 mg", medicationId: "rizatriptan", strength: "10 mg Rizatriptan", dosageForm: "Schmelztabletten", audience: "Erwachsene gemäß persönlichem Migräneplan", safetyNote: "Nicht mit anderen Triptanen oder Ergotamin-Mitteln ohne medizinische Anweisung kombinieren. Bei Herz-Kreislauf-Erkrankungen besonders vorsichtig; die App berechnet keine Dosis.", status: "Produktinformation abgeglichen", checkedOn: "24.07.2026", sourceLabel: "PatientenInfo-Service: Rizatriptan PUREN 10 mg", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/r/rizatriptan-puren-10-mg-schmelztabletten" },
  { tradeName: "Sertralin HEXAL 50 mg", medicationId: "sertralin", strength: "50 mg Sertralin", dosageForm: "Filmtabletten", audience: "Nur nach ärztlicher Verordnung", safetyNote: "Nicht abrupt absetzen oder selbst die Stärke ändern. Neue Unruhe, Suizidgedanken oder serotonerge Kombinationen sofort mit Praxis oder Apotheke besprechen; die App berechnet keine Dosis.", status: "Produktinformation abgeglichen", checkedOn: "24.07.2026", sourceLabel: "PatientenInfo-Service: Sertralin HEXAL 50 mg", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/s/sertralin-hexal-50mg-filmtabletten" },
  { tradeName: "Escitalopram – 1 A Pharma 10 mg", medicationId: "escitalopram", strength: "10 mg Escitalopram", dosageForm: "Filmtabletten", audience: "Nur nach ärztlicher Verordnung", safetyNote: "Nicht abrupt absetzen oder selbst die Stärke ändern. Bei Unruhe, Suizidgedanken, Herzstolpern oder neuen Medikamenten zeitnah medizinischen Rat einholen; die App berechnet keine Dosis.", status: "Produktinformation abgeglichen", checkedOn: "24.07.2026", sourceLabel: "PatientenInfo-Service: Escitalopram – 1 A Pharma 10 mg", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/e/escitalopram-1a-pharma-10mg-filmtabletten" },
  { tradeName: "Mirtazapin dura 30 mg", medicationId: "mirtazapin", strength: "30 mg Mirtazapin", dosageForm: "Filmtabletten", audience: "Nur nach ärztlicher Verordnung", safetyNote: "Kann stark müde machen und Stürze begünstigen. Nicht mit Alkohol oder anderen dämpfenden Mitteln ohne Rücksprache kombinieren; die App berechnet keine Dosis.", status: "Produktinformation abgeglichen", checkedOn: "24.07.2026", sourceLabel: "PatientenInfo-Service: Mirtazapin dura 30 mg", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/m/mirtazapin-dura-30-mg-filmtabletten/" },
  { tradeName: "Zolpidem 10 – 1 A Pharma", medicationId: "zolpidem", strength: "10 mg Zolpidem", dosageForm: "Filmtabletten", audience: "Erwachsene nur nach ärztlicher Verordnung", safetyNote: "Nicht mit Alkohol, Opioiden oder anderen Beruhigungsmitteln kombinieren. Nach der Einnahme nicht fahren; die App berechnet keine Dosis.", status: "Produktinformation abgeglichen", checkedOn: "24.07.2026", sourceLabel: "PatientenInfo-Service: Zolpidem 10 – 1 A Pharma", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/xyz/zolpidem-10-1a-pharma-filmtabletten" },
  { tradeName: "Circadin 2 mg", medicationId: "melatonin", strength: "2 mg Melatonin", dosageForm: "Retardtabletten", audience: "Menschen ab 55 Jahren gemäß Produktinformation", safetyNote: "Retardtabletten nicht beliebig durch andere Melatonin-Produkte ersetzen. Bei anhaltender Schlafstörung die Ursache medizinisch prüfen; die App berechnet keine Dosis.", status: "Produktinformation abgeglichen", checkedOn: "24.07.2026", sourceLabel: "EMA: Circadin – Produktinformation", sourceUrl: "https://www.ema.europa.eu/en/medicines/human/EPAR/circadin" },
  { tradeName: "Buscopan Dragées", medicationId: "butylscopolamin", strength: "10 mg Butylscopolaminbromid", dosageForm: "Überzogene Tabletten", audience: "Erwachsene und Jugendliche ab 6 Jahren gemäß Gebrauchsinformation", safetyNote: "Bei starken oder neuen Bauchschmerzen nicht nur selbst behandeln. Bei Grünem Star, Harnverhalt oder Darmverschluss-Verdacht vorher medizinisch abklären; die App berechnet keine Dosis.", status: "Produktinformation abgeglichen", checkedOn: "24.07.2026", sourceLabel: "PatientenInfo-Service: Buscopan Dragées", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/b/buscopanR-drages?schrift=0.7" },
  { tradeName: "Lefax 42 mg Kautabletten", medicationId: "simeticon", strength: "42 mg Simeticon", dosageForm: "Kautabletten", audience: "Altersbereich und konkrete Darreichungsform prüfen", safetyNote: "Nicht bei starken oder zunehmenden Bauchschmerzen, Erbrechen oder aufgeblähtem Bauch als alleinige Selbstbehandlung verwenden; die App berechnet keine Dosis.", status: "Produktinformation abgeglichen", checkedOn: "24.07.2026", sourceLabel: "PatientenInfo-Service: Lefax 42 mg Kautabletten", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/l/lefax?schrift=0.9" },
  { tradeName: "Naproxen 500 mg HEXAL", medicationId: "naproxen", strength: "500 mg Naproxen", dosageForm: "Tabletten", audience: "Erwachsene und Jugendliche gemäß ärztlichem Plan", safetyNote: "Nicht zusätzlich mit Ibuprofen, Diclofenac oder ASS als Schmerzmittel einnehmen. Bei Blutverdünnern, Magen-, Herz- oder Nierenproblemen vorher Rücksprache; die App berechnet keine Dosis.", status: "Produktinformation abgeglichen", checkedOn: "24.07.2026", sourceLabel: "PatientenInfo-Service: Naproxen 500 mg HEXAL", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/n/naproxen-500mg-hexal-tabletten" },
  { tradeName: "Diclo 50 – 1 A Pharma", medicationId: "diclofenac", strength: "50 mg Diclofenac", dosageForm: "Magensaftresistente Tabletten", audience: "Erwachsene und Jugendliche gemäß ärztlichem Plan", safetyNote: "Nicht zusätzlich mit anderen entzündungshemmenden Schmerzmitteln einnehmen. Bei Herz-Kreislauf-, Magen- oder Nierenproblemen zuerst ärztlich oder apothekerlich prüfen; die App berechnet keine Dosis.", status: "Produktinformation abgeglichen", checkedOn: "24.07.2026", sourceLabel: "PatientenInfo-Service: Diclo 50 – 1 A Pharma", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/d/diclo-50-1a-pharma-tabletten-magensaftresistent?schrift=0.7" },
  { tradeName: "Methocarbamol Aristo 750 mg", medicationId: "methocarbamol", strength: "750 mg Methocarbamol", dosageForm: "Tabletten", audience: "Erwachsene gemäß Produktinformation", safetyNote: "Kann müde und benommen machen. Nicht mit Alkohol, Opioiden oder anderen dämpfenden Medikamenten ohne Rücksprache kombinieren; die App berechnet keine Dosis.", status: "Produktinformation abgeglichen", checkedOn: "24.07.2026", sourceLabel: "PatientenInfo-Service: Methocarbamol Aristo 750 mg", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/m/methocarbamol-aristo-750-mg-tabletten" },
  { tradeName: "Skinoren 20 % Creme", medicationId: "azelainsaeure", strength: "200 mg Azelainsäure pro g Creme", dosageForm: "Creme zur Anwendung auf der Haut", audience: "Altersbereich und persönlicher Hautplan prüfen", safetyNote: "Nur äußerlich anwenden und Augen sowie Schleimhäute meiden. Bei starker Reizung oder fehlender Besserung dermatologisch abklären; die App berechnet keine Menge.", status: "Produktinformation abgeglichen", checkedOn: "24.07.2026", sourceLabel: "PatientenInfo-Service: Skinoren 20 % Creme", sourceUrl: "https://www.patienteninfo-service.de/a-z-liste/s/skinoren-20--creme" },
